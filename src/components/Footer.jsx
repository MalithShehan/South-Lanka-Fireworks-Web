          ...
          <div>
            ...
            <ul className="space-y-3">
              {FOOTER_LINKS.map(({ label, to }) => (
                <li key={to}>
                  <button
                    onClick={() => smoothScrollTo(to)}
                    className="flex cursor-pointer items-center gap-2 text-sm text-stone-300 transition duration-200 hover:text-amber-200 bg-transparent border-none w-full text-left"
                  >
